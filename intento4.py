...
def myNetwork():
    ...
    r1 = net.addHost('r1', cls=Node, ip='0.0.0.0',defaultRoute='via 10.10.10.5')
    r3 = net.addHost('r3', cls=Node, ip='0.0.0.0',defaultRoute='via 10.10.10.9')
    ...
    r1.cmd('ifconfig r1-eth2 10.10.10.6 netmask 255.255.255.252 up')
    ...
    nat0.cmd('ifconfig nat0-eth1 10.10.10.5 netmask 255.255.255.252 up')
    nat0.cmd('ifconfig nat0-eth2 10.10.10.9 netmask 255.255.255.252 up')
    nat0.cmd('ifconfig nat0-eth0 0.0.0.0 netmask 255.255.255.252 up')
    ...
    nat0.cmd('ip route add 192.168.1.0/24 via 10.10.10.6 dev nat0-eth1')
    nat0.cmd('ip route add 192.168.2.0/24 via 10.10.10.10 dev nat0-eth2')
