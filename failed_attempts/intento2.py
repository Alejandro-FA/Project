...
def myNetwork():
    ...
    nat0 = net.addHost('nat0', cls=NAT, ip='10.10.10.14/30', subnet='10.10.10.12/30', inetIntf='nat0-eth0', localIntf='nat0-eth1')
    ...
    net.addLink(r0, r1, intfName1='r0-eth1', params1={'ip':'10.10.10.5/30'}, intfName2='r1-eth2', params2={'ip':'10.10.10.6/30'})
    net.addLink(r0, r3, intfName1='r0-eth2', params1={'ip':'10.10.10.9/30'}, intfName2='r3-eth2', params2={'ip':'10.10.10.10/30'})
    net.addLink(r0, nat0, intfName1='r0-eth0', params1={'ip':'10.10.10.13/30'}, intfName2='nat0-eth0', params2={'ip':'10.10.10.14/30'})
    ...
    r0.cmd('ifconfig r0-eth0 10.10.10.6 netmask 255.255.255.252 up')
    r0.cmd('ifconfig r0-eth1 10.10.10.7 netmask 255.255.255.252 up')
    r0.cmd('ifconfig r0-eth2 10.10.10.9 netmask 255.255.255.252 up')
    ...
    r1.cmd('ifconfig r1-eth2 10.10.10.8 netmask 255.255.255.252 up')
    ...
    r3.cmd('ifconfig r1-eth2 10.10.10.10 netmask 255.255.255.252 up')

    info( '*** Configuring static routes\n')
    # Command to specify static routes
    r0.cmd('ip route add 192.168.2.0/24 via 10.10.10.2 dev r1-eth1')
    r0.cmd('ip route add 10.10.10.12/30 via 10.10.10.5 dev r1-eth2')

    r1.cmd('ip route add 192.168.2.0/24 via 10.10.10.2 dev r1-eth1')
    r1.cmd('ip route add 10.10.10.12/30 via 10.10.10.5 dev r1-eth2')

    r3.cmd('ip route add 192.168.1.0/24 via 10.10.10.1 dev r3-eth1')
    r3.cmd('ip route add 10.10.10.12/30 via 10.10.10.9 dev r1-eth2')
